...
class OrderItemSchema(BaseModel):
    product_slug: Annotated[
        str,
        Field(
            ..., title="slug", min_length=2, max_length=255, description="slug товара"
        ),
    ]
    quantity: Annotated[
        int, Field(default=1, gt=0, description="Количество товара в заказе")
    ]
...
class OrderItemOutSchema(OrderItemSchema):
    ...
    product_name: Annotated[
        str, Field(..., max_length=255, description="Название продукта")
    ]
    price_at_time: Annotated[
        ...
        Field(
            ...
            max_digits=10,
            decimal_places=2,
            description="Цена товара в момент заказа",
        ),
    ]
...
class OrderOutSchema(BaseModel):
    ...
    total_price: Annotated[
        Decimal,
        Field(..., ge=0, max_digits=10, decimal_places=2, description="Сумма заказа"),
    ]
    ...
    updated_at: Annotated[
        Optional[datetime], Field(default=None, title="Дата обновления заказа")
    ]
